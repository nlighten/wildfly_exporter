...
Download the latest [wildfly_exporter_module](https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22wildfly_exporter_module%22) from the maven repository and extract it in Wildfly's modules directory.
